...
import articlelist from './components/Vue/article/list.vue'
import articleadd from './components/Vue/article/add.vue'
import welcome from './components/Vue/welcome.vue'
/**
 * meta参数解析
...
const routes = [
  ...
  },
  {
    ...
    component: Home,
    children: [
      { path: 'article/list', component: articlelist, name: 'articlelist', meta: { hideLeft: false, module: 'Vueadmin', menu: 'articlelist' }},
      { path: 'article/add', component: articleadd, name: 'articleadd', meta: { hideLeft: false, module: 'Vueadmin', menu: 'articleadd' }}
    ]
  },
  {
    path: '/vue',
    component: Home,
    children: [
      { path: 'welcome', component: welcome, name: 'welcome', meta: { hideLeft: false, module: 'Vueadmin', menu: 'welcome' }}
    ]
  }
]
