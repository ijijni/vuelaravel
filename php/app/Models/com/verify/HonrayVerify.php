...
namespace App\Models\com\verify;
...
class HonrayVerify
{
    ...
    public function check($code, $id = '')
    {
        ...
        // 验证码不能为空
        $secode = cache($key);
        if (empty($code) || empty($secode) || !$secode) {
            return false;
        }
        // 缓存 过期
    ...
    public function entry($id = '')
    {
        ...
        return response($content, 200, ['Content-Length' => strlen($content)])->header('Content-Type', 'image/png');
    }
