...
class HonrayAuth{
    ...
    public $_config = array(
        ...
        'AUTH_GROUP'        => 'zvue_admin_group',                     // 用户组数据表名
        'AUTH_GROUP_ACCESS' => 'zvue_admin_access',                // 用户-用户组关系表
        'AUTH_RULE'         => 'zvue_admin_rule',                      // 权限规则表
        'AUTH_USER'         => 'zvue_admin_user'                       // 用户信息表
    );
    ...
    public function getGroups($uid) { 
        ...
        if (isset($groups[$uid]))
            return $groups[$uid];
        $user_groups=User::where('uid', $uid)->first()->toArray();
    ...
    protected function getAuthList($uid) {
        ...
        if ($this->_config['AUTH_TYPE'] == 2) {
            ...
            cache(['Auth_'.$this->auth_key=>$cache_info],60);
        }
        return $authList; 
    }
    ...
    public function updateCacheAuth(){
        ...
        cache(['Auth_'.$this->auth_key=>$cache], 60);
